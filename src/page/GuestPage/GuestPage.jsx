          ...
          >
            <Col md={2}>
              <Dropdown className="w-100">
                ...
                <Dropdown.Menu>
                  <Dropdown.Item onClick={() => setTypeGuests("ALl Guests")}>
                    All Guests
                  </Dropdown.Item>
                  <Dropdown.Item onClick={() => setTypeGuests("Normal")}>
                    Normal
                  </Dropdown.Item>
                  <Dropdown.Item onClick={() => setTypeGuests("VIP")}>
                    VIP
                  </Dropdown.Item>
                </Dropdown.Menu>
              </Dropdown>
            ...
            <Col md={2}>
              <Button variant="dark">Add New Guest</Button>
            </Col>
          </Row>
